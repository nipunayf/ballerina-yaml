...
function simpleEventDataGen() returns map<[Event[], string[]]> {
    return {
        ...
        "nested flow mapping": [[{startType: MAPPING, flowStyle: true}, {value: "parentKey", isKey:true}, {startType: MAPPING, flowStyle: true}, {value: "key", isKey:true}, {value: "value"}], ["{parentKey: {key: value}}"]],
